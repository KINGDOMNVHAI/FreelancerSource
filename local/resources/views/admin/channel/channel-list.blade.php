                    ...
                    <div class="card-body row">
                        <div class="col-md-2">
                            <div class="form-group">
                                <input type="text" name="name_channel" id="name_channel" class="form-control" placeholder="Tên kênh">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="dropdown bootstrap-select show-tick">
                                <select class="selectpicker" name="year" id="year" data-style="select-with-transition" title="Năm thành lập">
                        ...
                        <div class="col-md-2">
                            <div class="dropdown bootstrap-select show-tick">
                                <select class="selectpicker" name="subscribe_filter" id="subscribe_filter" data-style="select-with-transition" title="Số subscribe" data-size="7" tabindex="-98">
                                    <option value="desc" <?php echo (isset($_GET['subscribe_filter']) && $_GET['subscribe_filter'] == 'desc') ? 'selected' : '' ?>>Nhiều nhất </option>
                                    <option value="asc" <?php echo (isset($_GET['subscribe_filter']) && $_GET['subscribe_filter'] == 'asc') ? 'selected' : '' ?>>Ít nhất</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-1">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            @else
                                            <div class="img-container">
                                                <img src="upload/images/thumbnail/{{ $post->thumbnail_post }}" alt="...">
                                            </div>
                                            @endif
                                        </td>
                                        <td>{{ $post->name_vi_post }}</td>
                                        <td>{{ $post->present_vi_post }}</td>
                                        <td>
