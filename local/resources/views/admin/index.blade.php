...
<body class="">
  ...
  <div class="wrapper ">
    <div class="sidebar" data-color="rose" data-background-color="black" data-image="{{ asset('admin/assets/img/sidebar-7.jpg') }}">
      <!--
    ...
    -->
      <div class="logo">
        ...
        <a href="/" class="simple-text logo-normal"> KINGDOM NVHAI </a> -->
      </div>
      <div class="sidebar-wrapper">
        ...
        <ul class="nav">
          ...
          @if (Auth::user()->role == ROLE_ADMIN)
            @include('admin.block.admin-menu');
          @elseif (Auth::user()->role == ROLE_EDITOR)
            @include('admin.block.editor-menu');
          @elseif (Auth::user()->role == ROLE_WRITER)
            @include('admin.block.writer-menu');
          @else
            @include('admin.block.user-menu');
          @endif
        </ul>
      </div>
    </div>
                    ...
                    <p>Log out</p>
                      <script>
                        function userLogout() {
                            ...
                            var c = base_url + "/bookstore/logout";
  ...
  <script src="{{ asset('admin/cdnjs.cloudflare.com/ajax/libs/core-js/2.4.1/core.js') }}"></script>
  ...
  <script src="{{ asset('admin/assets/js/material-dashboard.minf066.js?v=2.1.0') }}" type="text/javascript"></script>
