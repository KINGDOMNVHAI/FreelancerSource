...
<div class="container-fluid pt-5">
    <div class="row px-xl-5">
        ...
        <div class="col-lg-5 mb-5">
            <h5 class="font-weight-semi-bold mb-3">Nền tảng tri thức cho mọi người</h5>
            <p>Các bạn có nhu cầu liên lạc, trao đổi hoặc đóng góp ý kiến, vui lòng tham khảo các thông tin sau: </p>
