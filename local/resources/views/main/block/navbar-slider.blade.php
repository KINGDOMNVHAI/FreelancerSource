            ...
            <nav class="collapse show navbar navbar-vertical navbar-light align-items-start p-0 border border-top-0 border-bottom-0" id="navbar-vertical">
                <div class="navbar-nav w-100 overflow-hidden" style="height: 410px">
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link" data-toggle="dropdown">Ngoại văn <i class="fa fa-angle-down float-right mt-1"></i></a>
                        <div class="dropdown-menu position-absolute bg-secondary border-0 rounded-0 w-100 m-0">
                            <a href="" class="dropdown-item">Tiếng Anh</a>
                            <a href="" class="dropdown-item">Tiếng Nhật</a>
                        </div>
                    </div>
                    <a href="" class="nav-item nav-link">Kinh tế</a>
                    <a href="" class="nav-item nav-link">Manga</a>
                    <a href="" class="nav-item nav-link">Văn phòng phẩm</a>
                </div>
            </nav>
        </div>
        <div class="col-lg-9">
