...
<body class="home page-template-default page page-id-8 theme-agrosector woocommerce-no-js  elementor-default elementor-kit-1708 elementor-page elementor-page-8" data-theme-color="#b2b74a">
                    ...
                    <div class='top_left left header_side'>
                        <div class='header_side_container'>
                            <div class="gt3_header_builder_component gt3_header_builder_text_component">
                                <p><img style="width: 13px; margin-right: 10px;" src="{{asset('FEFood/img/icon-1.png')}}" alt="Phone" />800 326 9054</p>
                            </div>
                            <div class="gt3_header_builder_component gt3_header_builder_empty_space_component"></div>
                            <div class="gt3_header_builder_component gt3_header_builder_text_component">
                                <p><img style="width: 13px; margin-right: 10px;" src="{{asset('FEFood/img/icon-2.png')}}" alt="E-Mail" />abcdefghijklmnopqrstuvwxy@example.com.vn</p>
                            </div>
                            <div class="gt3_header_builder_component gt3_header_builder_empty_space_component"></div>
                            <div class="gt3_header_builder_component gt3_header_builder_text_component">
                                <p><img style="width: 13px; margin-right: 10px;" src="{{asset('FEFood/img/icon-location.png')}}" alt="Time" />Mon - Fri: 9:00 - 19:00</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class='middle_left left header_side'>
                        <div class='header_side_container'>
                            <div class='logo_container mobile_logo_enable'>
                                <a href="{{route('home')}}">
                                    <img class="default_logo" src="{{asset('FEFood/img/logo-agro-sector.png')}}" alt="logo" style="height:46px;">
                                    <img class="mobile_logo" src="{{asset('FEFood/img/logo-agro-sector.png')}}" alt="logo">
                                </a>
                            </div>
                        </div>
                    </div>
    ...
    <link rel='stylesheet' id='gt3pg-pro-blocks-frontend-css' href="{{asset('FEFood/wp-content/plugins/gt3-photo-video-gallery-pro/dist/css/gutenberg/frontend41b3.css?ver=1607594208')}}" type='text/css' media='all' />
    <script type='text/javascript' src="{{asset('FEFood/wp-content/plugins/gt3-themes-core/dist/js/coree9ae.js?ver=1608034921')}}" id='gt3-core/core-js'></script>
    <script type='text/javascript' src="{{asset('FEFood/wp-content/plugins/gt3-themes-core/dist/js/widgets/columne9ae.js?ver=1608034921')}}" id='gt3-core/widgets/column-js'></script>
    <script type='text/javascript' src="{{asset('FEFood/wp-includes/js/imagesloaded.mineda1.js?ver=4.1.4')}}" id='imagesloaded-js'></script>
    ...
    <script type='text/javascript' src="{{asset('FEFood/wp-content/plugins/gt3-photo-video-gallery/dist/js/deprecated/frontend0c55.js?ver=1608214589')}}" id='blueimp-gallery.js-js'></script>
    <script type='text/javascript' src="{{asset('FEFood/wp-includes/js/dist/vendor/wp-polyfill.min89b1.js?ver=7.4.4')}}" id="wp-polyfill-js"></script>
    ...
    <script type='text/javascript' src="{{asset('FEFood/wp-includes/js/dist/i18n.min3a83.js?ver=326fe7fbfdb407b6edbcfba7e17f3909')}}" id="wp-i18n-js"></script>
    ...
    <script type='text/javascript' src="{{asset('FEFood/wp-content/plugins/gt3-photo-video-gallery-pro/dist/js/deprecated2065.js?ver=1.7.0.0')}}" id="gt3pg_pro_frontend-js"></script>
    ...
    <script type='text/javascript' src="{{asset('FEFood/wp-content/plugins/contact-form-7/includes/js/scripts9dff.js?ver=5.3.2')}}" id='contact-form-7-js'></script>
    <script type='text/javascript' src="{{asset('FEFood/wp-content/plugins/woocommerce/assets/js/jquery-blockui/jquery.blockUI.min44fd.js?ver=2.70')}}" id='jquery-blockui-js'></script>
    ...
    <script type='text/javascript' src="{{asset('FEFood/wp-content/plugins/woocommerce/assets/js/FEFood/add-to-cart.min287d.js?ver=4.8.0')}}" id='wc-add-to-cart-js'></script>
    <script type='text/javascript' src="{{asset('FEFood/wp-content/plugins/woocommerce/assets/js/js-cookie/js.cookie.min6b25.js?ver=2.1.4')}}" id='js-cookie-js'></script>
    ...
    <script type='text/javascript' src="{{asset('FEFood/wp-content/plugins/woocommerce/assets/js/FEFood/woocommerce.min287d.js?ver=4.8.0')}}" id='woocommerce-js'></script>
    ...
    <script type='text/javascript' src="{{asset('FEFood/wp-content/plugins/woocommerce/assets/js/FEFood/cart-fragments.min287d.js?ver=4.8.0')}}" id='wc-cart-fragments-js'></script>
    <script type='text/javascript' src="{{asset('FEFood/wp-content/themes/agrosector/woocommerce/js/theme-woo40df.js?ver=5.6')}}" id='gt3-main-woo-js'></script>
    <script type='text/javascript' src="{{asset('FEFood/wp-content/themes/agrosector/woocommerce/js/infinite-scroll.pkgd.min8d18.js?ver=3.0.5')}}" id='gt3-infinite-scroll-js'></script>
    <script type='text/javascript' src="{{asset('FEFood/wp-content/themes/agrosector/js/jquery.appear.min40df.js?ver=5.6')}}" id='gt3-appear-js'></script>
    <script type='text/javascript' src="{{asset('FEFood/wp-content/themes/agrosector/js/jquery.cookie40df.js?ver=5.6')}}" id='cookie-js'></script>
    ...
    <script type='text/javascript' src="{{asset('FEFood/wp-content/themes/agrosector/js/themec2d0.js?ver=1.4.4')}}" id='gt3-theme-js'></script>
    <script type='text/javascript' src="{{asset('FEFood/wp-content/themes/agrosector/js/jquery.event.swipe40df.js?ver=5.6')}}" id='event-swipe-js'></script>
    <script type='text/javascript' src="{{asset('FEFood/wp-content/plugins/woocommerce/assets/js/select2/select2.full.minfa0c.js?ver=4.0.3')}}" id='select2-js'></script>
    <script type='text/javascript' src="{{asset('FEFood/wp-includes/js/wp-embed.min40df.js?ver=5.6')}}" id="wp-embed-js"></script>
    <script type='text/javascript' src="{{asset('FEFood/wp-content/plugins/gt3-themes-core/dist/js/widgets/gt3-core-emptyspacee9ae.js?ver=1608034921')}}" id='gt3-core/widgets/gt3-core-emptyspace-js'></script>
    <script type='text/javascript' src="{{asset('FEFood/wp-content/plugins/gt3-themes-core/dist/js/widgets/gt3-core-buttone9ae.js?ver=1608034921')}}" id='gt3-core/widgets/gt3-core-button-js'></script>
    <script type='text/javascript' id='gt3pg_pro--core-js-extra'>
        /* <![CDATA[ */ ;
        window.resturl = window.resturl || "https://livewp.site/wp/md/agrosector/wp-json/";
        /* ]]> */
    </script>
    <script type='text/javascript' src="{{asset('FEFood/wp-content/plugins/gt3-photo-video-gallery-pro/dist/js/FEFood/core41b3.js?ver=1607594208')}}" id="gt3pg_pro--core-js"></script>
    <script type='text/javascript' src="{{asset('FEFood/wp-content/plugins/gt3-photo-video-gallery-pro/dist/js/FEFood/lightbox41b3.js?ver=1607594208')}}" id="gt3pg_pro--lightbox-js"></script>
    <script type='text/javascript' src="{{asset('FEFood/wp-content/plugins/gt3-photo-video-gallery-pro/dist/js/FEFood/thumbnails41b3.js?ver=1607594208')}}" id="gt3pg_pro--thumbnails-js"></script>
    <script type='text/javascript' src="{{asset('FEFood/wp-includes/js/jquery/ui/tabs.min35d0.js?ver=1.12.1')}}" id='jquery-ui-tabs-js'></script>
    <script type='text/javascript' src="{{asset('FEFood/wp-includes/js/jquery/ui/accordion.min35d0.js?ver=1.12.1')}}" id='jquery-ui-accordion-js'></script>
    ...
    <script type='text/javascript' src="{{asset('FEFood/wp-content/plugins/gt3-photo-video-gallery-pro/dist/js/gutenberg/frontend41b3.js?ver=1607594208')}}" id="gt3pg-pro-frontend-js"></script>
    <script type='text/javascript' src="{{asset('FEFood/wp-content/plugins/gt3-themes-core/core/elementor/assets/js/circle-progress.min3ba1.js?ver=1.3.3')}}" id="circle-progress-js"></script>
    <script type='text/javascript' src="{{asset('FEFood/wp-content/plugins/gt3-themes-core/dist/js/widgets/gt3-core-piecharte9ae.js?ver=1608034921')}}" id="gt3-core/widgets/gt3-core-piechart-js"></script>
    <script type='text/javascript' src="{{asset('FEFood/wp-content/plugins/gt3-themes-core/core/elementor/assets/js/slick3ba1.js?ver=1.3.3')}}" id="slick-js"></script>
    <script type='text/javascript' src="{{asset('FEFood/wp-content/plugins/gt3-themes-core/dist/js/widgets/gt3-core-testimonialse9ae.js?ver=1608034921')}}" id="gt3-core/widgets/gt3-core-testimonials-js"></script>
    <script type='text/javascript' src="{{asset('FEFood/wp-content/plugins/gt3-themes-core/dist/js/isotopee9ae.js?ver=1608034921')}}" id="gt3-core/isotope-js"></script>
    <script type='text/javascript' src="{{asset('FEFood/wp-content/plugins/gt3-themes-core/dist/js/widgets/gt3-core-bloge9ae.js?ver=1608034921')}}" id="gt3-core/widgets/gt3-core-blog-js"></script>
    <script type='text/javascript' src="{{asset('FEFood/wp-includes/js/comment-reply.min40df.js?ver=5.6')}}" id='comment-reply-js'></script>
    <script type='text/javascript' src="{{asset('FEFood/wp-content/plugins/gt3-themes-core/core/elementor/assets/js/core-gridlist-woo3ba1.js?ver=1.3.3')}}" id='gt3-gridlist-woo-js'></script>
    <script type='text/javascript' src="{{asset('FEFood/wp-content/plugins/elementor/assets/js/frontend-modules.minc578.js?ver=3.0.14')}}" id='elementor-frontend-modules-js'></script>
    <script type='text/javascript' src="{{asset('FEFood/wp-content/plugins/elementor/assets/lib/dialog/dialog.mina288.js?ver=4.8.1')}}" id='elementor-dialog-js'></script>
    <script type='text/javascript' src="{{asset('FEFood/wp-content/plugins/elementor/assets/lib/waypoints/waypoints.min05da.js?ver=4.0.2')}}" id='elementor-waypoints-js'></script>
    <script type='text/javascript' src="{{asset('FEFood/wp-content/plugins/elementor/assets/lib/swiper/swiper.min48f5.js?ver=5.3.6')}}" id='swiper-js'></script>
    <script type='text/javascript' src="{{asset('FEFood/wp-content/plugins/elementor/assets/lib/share-link/share-link.minc578.js?ver=3.0.14')}}" id='share-link-js'></script>
    ...
    <script type='text/javascript' src="{{asset('FEFood/wp-content/plugins/elementor/assets/js/frontend.minc578.js?ver=3.0.14')}}" id='elementor-frontend-js'></script>
    <script type='text/javascript' src="{{asset('FEFood/wp-content/plugins/gt3-themes-core/core/elementor/assets/js/core-frontend3ba1.js?ver=1.3.3')}}" id='gt3-elementor-core-frontend-core-js'></script>
